"""
SQLAlchemy models — Conversation and Message.
...
class Message(Base):
    """A single message inside a conversation (user or bot)."""
    ...
    # Only relevant for bot messages
    ...
    def __repr__(self):
        return f"<Message(message_id={self.message_id}, role={self.role}, conversation_id={self.conversation_id})>"
